...
$folder:=$homeFolder.folder("mmBERT-small")
$path:="mmBERT-small-Q8_0.gguf"
$URL:="keisuke-miyako/mmBERT-small-gguf-q8_0"
...
$folder:=$homeFolder.folder("mmBERT-small")
$path:="mmBERT-small-onnx-int8"
$URL:="keisuke-miyako/mmBERT-small-onnx-int8"
